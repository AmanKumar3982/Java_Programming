...
public class App{
    public static void createTable(){
        ...
        try(Connection c = DriverManager.getConnection(DB_URL, USER, PASS);Statement s = c.createStatement()){
            String sql = "CREATE TABLE PAYSLIP.PAYSLIP(ID INT,NAME VARCHAR(100), WORKING_DAYS INT,DAILYWAGES DOUBLE,DEDUCTION DOUBLE,BONUS DOUBLE,TYPE VARCHAR(2),SALARY DOUBLE)";
            s.executeUpdate(sql);
